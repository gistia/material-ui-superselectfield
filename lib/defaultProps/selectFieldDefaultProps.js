...
const _FlatButton = require('material-ui/FlatButton/FlatButton');

const _FlatButton2 = _interopRequireDefault(_FlatButton);
...
exports.default = {
  ...
  popoverClassName: '',
  popoverWidth: 180,
  resetButton: _react2.default.createElement(_FlatButton2.default, {
    label: 'reset',
